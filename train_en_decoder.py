...
from idea import yang_5_4,yang_5_16,yang_5_29
...
def main(args):
    ...
    model = yang_5_29.Net(num_classes=NUM_CLASSES)
    ...
    if (not args.state):
        ...
        model = yang_5_29.Net(NUM_CLASSES, encoder=pretrainedEnc)  #Add decoder to encoder
        if args.cuda:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--state',default="/home/wawa/yang_net/save/logs_6_6/model_encoder_best.pth")

    parser.add_argument('--port', type=int, default=8097)
    parser.add_argument('--datadir', default="/home/wawa/yang_net/datasets/cityscapes")   # 数据集地址
    parser.add_argument('--savedir', default="/home/wawa/yang_net/save/logs_6_6")             # 权重保存地址
    ...
    parser.add_argument('--batch-size', type=int, default=5)    # dataloader的单次训练图片数
    ...
    parser.add_argument('--resume', action='store_true',default=True)    # 继续训练
