...
class SegmentationMetric(object):
    ...
    def __init__(self, numClass):
        ...
        self.confusionMatrix = torch.zeros((self.numClass, self.numClass)) # 混淆矩阵（空）
...
#     ignore_labels = [255]
#     metric = SegmentationMetric(num_class) # 3表示有3个分类，有几个分类就填几, 0也是1个分类
#     hist = metric.addBatch(output, imgLabel,ignore_labels)
