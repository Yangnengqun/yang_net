...
def main(args):
    ...
    model = yang_regseg_ghost.Net(num_classes=NUM_CLASSES)
    model = model.to(device)
    
    print("==========TRAINING ===========")
    train(args, model, False)   #Train 
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--state',default="/home/wawa/yang_net/save/logs_5_17/model_encoder_best.pth")

    parser.add_argument('--port', type=int, default=8097)
    parser.add_argument('--datadir', default="/home/wawa/yang_net/datasets/cityscapes")   # 数据集地址
    parser.add_argument('--savedir', default="/home/wawa/yang_net/save/logs_regseg_ghost")             # 权重保存地址
    parser.add_argument('--height', type=int, default=512)     # 图片的H
    parser.add_argument('--num-epochs', type=int, default=400)  # 训练轮数
